...
const TVShows = () => {
    ...
    const sortOptions = [
        ...
        { value: 'first_air_date.desc', label: language === 'ar' ? 'الأحدث' : 'Newest' },
        { value: 'first_air_date.asc', label: language === 'ar' ? 'الأقدم' : 'Oldest' },
    ];
    ...
    useEffect(() => {
        const loadGenres = async () => {
            try {
                const data = await fetchGenres('tv', getApiLanguage());
                setGenres(data);
            } catch (error) {
